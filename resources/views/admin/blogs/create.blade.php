...
<head>
    ...
    <title>Add Blog - GovtAlerts</title>
        ...
        <div class="grow d-flex flex-column">
            ...
            <main class="p-4 grow">
                <div class="form-box-jobyaari">
                    <h5 class="widget-title mb-4 fw-bold">Add Organisation</h5>
                    ...
                    <form action="/admin/blogs/store" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="Write Blog title" required>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="dashed-upload-zone" onclick="document.getElementById('image-file-input').click()">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="short_description" rows="3" class="form-control" placeholder="Brief summary of the blog post..." required></textarea>
                        </div>

                        <!-- Full Rich Text Editor -->
                        <div class="mb-4">
                            <label class="form-label">Blog Content <span class="text-danger">*</span></label>
                            <div id="editor" style="min-height: 300px; font-size: 16px;"></div>
